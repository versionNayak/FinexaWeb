...
$('input:radio[name="ex"]').change(function(){
    if($(this).val() == 'yes'){
      $(".displayonyes").show();
    }
	if($(this).val() == 'no'){
...
Highcharts.chart('idcaa1', {
    ...
    series: [{
        name: 'Amount',
		 innerSize: '50%',
        data: [
            { name: 'Overall Interest Recieved', y: 20, color: '#95ceff' },
            { name: 'Total Amount Invested', y: 10.25, color:'#f7a35c' },
 ...
 Highcharts.chart('stdgraph', {
    ...
    xAxis: {
        categories: ['2013-2014', '2014-2015', '2015-2016', '2016-2017', '2017-2018','2018-2019', '2019-2020', '2020-2021','2021-2022','2022-2023','2023-2024','2024-2025','2025-2026','2026-2027','2027-2028','2028-2029'],
    ...
    series: [
	{
        ...
        data: [200,600, 1000,1500, 2000, 2500, 3000,3500,4000,4500,5000,5500,6000,6500,7000,7500],
		color:'#ff9900'
    },{
        name: 'Total Amount Deposited',
        data: [2000,2500, 3000, 3500, 4000, 4500,5000,5500,6000,6500,7000,7500,8000,8500,9000,9500],
		color: '#58ACFA'
    }]
});