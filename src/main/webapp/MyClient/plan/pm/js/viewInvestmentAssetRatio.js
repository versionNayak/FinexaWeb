	Highcharts.chart('idRiskScoreInvestment', {
	    chart: {
	        type: 'gauge',
		},
	    pane: {
	    ...
	    series:[{
			...
			dataLabels: {
				formatter: function () {
					...
					if(kmh < 0){
						var newvar = [0];
						var chart = $('#idRiskScoreInvestment').highcharts(); 
						chart.series[0].setData(newvar,true);
						
						$("#idRiskScoreInvestment .highcharts-data-labels .highcharts-label:nth-child(1)").hide();
