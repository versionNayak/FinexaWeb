...
Highcharts.chart('idRiskScoreSolvency', {
	    chart: {
	        type: 'gauge',
		},
	    pane: {
	    ...
	    series:[{
			...
			dataLabels: {
				formatter: function () {
					...
					if(kmh < -40){
						var newvar = [-40];
						var chart = $('#idRiskScoreSolvency').highcharts(); 
						chart.series[0].setData(newvar,true);
						
						$("#idRiskScoreSolvency .highcharts-data-labels .highcharts-label:nth-child(1)").hide();
