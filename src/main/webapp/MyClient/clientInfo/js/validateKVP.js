function validateKVP(form) {
	...
	lMaturityDate.style.border = "1px solid #ccc";
...
//	return false;
	...
	if (!hasValue(lMaturityDate.value)) {
		document.getElementById('alertMaturitytDate').innerHTML="Please enter Deposit Maturity Date";
		lMaturityDate.style.border = "2px solid red";
		lMaturityDate.style.borderRadius = "7px";
		errSS=1;
	}
