...
$(document).ready( function() {
	...
	//	alert("val "+$("#IdlookupGoalType").val());

	var selectedGoalType = sessionStorage.getItem("SELECTED_GOAL_TYPE");		
	console.log('Ín addGoalNonRetirementNonRecurring.js Goal Type: '+ selectedGoalType);
	...
	var lLoanRequiredSelectedValue=$("idloanRequired").val();
       
	//alert('lLoanRequiredSelectedValue: '+lLoanRequiredSelectedValue);
	...
	getAge($("#idAge"),'clientGoal/getAge/'+selectedImageFamilyMemberid); 
	...
	if (pagemode=="EDIT") {
		getSelectedGoalNonRetirementNonRecurring();
	}	
...
function getSelectedGoalNonRetirementNonRecurring(){
	selectedGoalID = sessionStorage.getItem("SELECTED_GOAL_ID");	
	console.log('In EDIT Goal ID: '+selectedGoalID);
	...
	function onGetGoalDataSuccess(data) {
		...
		if(data.expectedReturnOnCorpus!=null){
			console.log('Expected Return On Corpus: '+data.expectedReturnOnCorpus);
		...
		populateForm($('#GoalNonRecurringForm'),data);
...
function getLifeExpectancy(textBoxId,serviceUrl){
	//console.log("Getting Life Expectancy");
...
$("#idSaveGoal").on('click', function (e) {	
	...
	if(selectedImageFamilyMemberid==undefined){
	    ...
	    var form= document.getElementById("GoalNonRecurringForm");
...
/*		else 			
			alert('Goal Non Recurring Validation Errors');
*/	
	}
...
function saveGoal() {
	...
	//alert('In Goal Non Recurring Save');
	selectedImageFamilyMemberid = sessionStorage.getItem("SELECTED_FAMILY_MEMBER_ID");
	var selectedClientId = sessionStorage.getItem("SELECTED_CLIENT_ID");
	var formData = $('#GoalNonRecurringForm').serializeToJSON();
	...
	//	alert(data);
	//getClientDataWithErrorHandling("POST", data,saveURL,onCreateGoalSuccess, onAddGoalNonRecurringError);
	...
	/*function onAddGoalNonRecurringError(err) {
