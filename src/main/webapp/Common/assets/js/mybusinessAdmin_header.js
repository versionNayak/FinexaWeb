$(document).ready(function() {
    ...
    /*$("#idmasters").addClass('active_img');
    $("#idmf").addClass('active_img');
    ...
    $("#idClientMonitoring").click(function() {
        $("#dashbord").empty();
        $("#sidebar-wrapper").load("../Common/partials/mybusiness_sidebar_client_monitoring.html");
        $(".dashboardheading").html("Client Monitoring");
        $("#dashbord").load("Client_Monotoring/viewClientMonotoringDashboard.html");
    });

    $("#idExceptions").click(function() {
        $("#dashbord").empty();
        $("#sidebar-wrapper").load("../Common/partials/mybusiness_sidebar_exceptions.html");
        $(".dashboardheading").html("Finexa Exception Handling");
        $("#dashbord").load("exceptionHandling/viewExceptionHandlingDashboard.html");
    });
