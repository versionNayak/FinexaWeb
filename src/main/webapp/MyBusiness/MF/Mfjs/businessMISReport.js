...
$("#idOptionsForReport input[name='reportOption']").click(function(){
    alert('You clicked radio!');
    if($('input:radio[name=reportOption]:checked').val() == "byRM"){
        //alert($('input:radio[name=reportOption]:checked').val());
        $('#idEuin').attr('readonly', false);
    } else {
    	$('#idEuin').attr('readonly', true);
    }
});
