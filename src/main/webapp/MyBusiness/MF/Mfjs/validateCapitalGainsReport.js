...
function validateGainLossReportGeneration(form,clientId,fundHouseName,isin,checkedFamilyMemberId) {
...
function validateGainLossReportExport(form, clientId, fundHouseName, isin, reportFormat, checkedFamilyMemberId) {
