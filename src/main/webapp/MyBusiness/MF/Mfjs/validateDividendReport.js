function validateDividendReportGeneration(form,clientId,fundHouseName,isin,checkedFamilyMemberId) {
...
function validateDividendReportExport(form,clientId,fundHouseName,isin,reportFormat,checkedFamilyMemberId) {
