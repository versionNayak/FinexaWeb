...
$(document).ready(function() {
    ...
    serviceurl = "getSchemeListNoNavData/"+ nextFetch;
	...
	function onSuccess(data) {
		...
		$.each(data, function (index, navList) {
			...
			'<td>' + navList.assetClass + '</td>' +
			'<td>' + navList.dayOneNAV + '</td>' +
			'<td class="hidden"><input type="text" id="idIsin" name="isin"  value="' + navList.isin + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idSchemeName" name="schemeName"  value="' + navList.schemeName + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal1" name="dayVal1"  value="' + navList.dayOneNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal2" name="dayVal2"  value="' + navList.dayTwoNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal3" name="dayVal3"  value="' + navList.dayThreeNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal4" name="dayVal4"  value="' + navList.dayFourNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal5" name="dayVal5"  value="' + navList.dayFiveNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal6" name="dayVal6"  value="' + navList.daySixNAV + '" readonly="readonly"></td>' +
			'<td class="hidden"><input type="text" id="idDayVal7" name="dayVal7"  value="' + navList.daySevenNAV + '" readonly="readonly"></td>' +
			'</tr>');
		});
...
//			var downloadURL = ClientServiceUrl+'clientRecord/'+fileFormat+'/downloadClientTemplate';
	    	...
	    	var downloadURL = ClientServiceUrl+'NoNAVData/downloadExcel';
