...
function aa(p,mdate){
	//alert("nnnnn");
	//alert("Inside iscomare1 "+mdate);
	var monthName1 = mdate.slice(0,3);
	//alert('monthName1 '+ monthName1);
	var monthNumber1 = new Date(Date.parse(monthName1 +" 1, 2017")).getMonth()+1;
	//alert('monthNumber1. '+ monthNumber1);
	var year1 = mdate.slice(8,12);
	//alert('Year1'+ year1);
	var day=mdate.slice(4,6);
	var iDateReformatted1 = year1.concat("-", monthNumber1, "-",day);
	//var iDateReformatted  = month.concat("-", year);
	//alert ("iDateReformatted: " + iDateReformatted1);
	var lDate1 = new Date(iDateReformatted1);
	...
	var iDateReformatted  = year.concat("-", monthNumber, "-01");
	//var iDateReformatted  = month.concat("-", year);
//	alert ("iDateReformatted: " + iDateReformatted);
	var lDate = new Date(iDateReformatted.toString());
	//alert ("lDate: " + lDate);
	var selectedDate=new Date(lDate.toString());
	//alert('Selected Date '+ selectedDate);
	//alert('mdate '+ mdate);
...
function bb(p1,gnumber,mdate1){
//	alert("nnnnn");
//	alert(p1);
//	alert(mdate1);
//	alert(gnumber);
//	alert("Inside iscomare1 "+mdate1);
	var monthName1 = mdate1.slice(0,3);
//	alert('monthName1 '+ monthName1);
	var monthNumber1 = new Date(Date.parse(monthName1 +" 1, 2017")).getMonth()+1;
//	alert('monthNumber1. '+ monthNumber1);
	var year1 = mdate1.slice(8,12);
//	alert('Year1'+ year1);
	var day=mdate1.slice(4,6);
	var iDateReformatted1 = year1.concat("-", monthNumber1, "-",day);
	//var iDateReformatted  = month.concat("-", year);
//	alert ("mdate1: " + iDateReformatted1);
	var lDate1 = new Date(iDateReformatted1);
...
//	alert('Inside iscomare2 '+p1);
	var monthName = p1.slice(0,3);
//	alert('Month '+ monthName);
	var monthNumber = new Date(Date.parse(monthName +" 1, 2017")).getMonth()+1;
//	alert('monthNumber. '+ monthNumber);
	var year = p1.slice(4);
...
//	alert ("iDateReformatted: " + iDateReformatted);
	var lDate = new Date(iDateReformatted);
//	alert ("Selected Date1: " + lDate);
	var selectedDate=new Date(lDate.toString());
//	alert('Selected Date1-2 '+ selectedDate);
	//alert('mdate '+ mdate);
	//ldate Jun 12, 2050 12:00:00 AM
	
	
	var lStartDatePlusRecurringYears = moment(lDate,"YYYY-MM-DD").add(Number(gnumber), 'years');
//	alert("after moment lStartDatePlusRecurringYears "+lStartDatePlusRecurringYears);
	var lDate = moment(iDateReformatted1,"YYYY-MM-DD");
//	alert("after moment lDate "+lDate);
	
	if(lStartDatePlusRecurringYears>lDate){
	//	alert("false");
		return false;
	}
	else {
...
function cc(bdate,Lnumber,mdate1){
//	alert("nnnnn");
//	alert(p1);
//	alert(bdate);
//	alert(Lnumber);
...
//	alert('Year1'+ year1);
	var day=mdate1.slice(4,6);
	var mdate111 = year1.concat("-", monthNumber1, "-",day);
//	alert('mdate111'+ mdate111);
	
	
	 monthName1 = bdate.slice(0,3);
//	alert('monthName1 '+ monthName1);
	 monthNumber1 = new Date(Date.parse(monthName1 +" 1, 2017")).getMonth()+1;
//	alert('monthNumber1. '+ monthNumber1);
	 year1 =bdate.slice(8,12);
//	alert('Year1'+ year1);
	var day=bdate.slice(4,6);
	var iDateReformatted1 = year1.concat("-", monthNumber1, "-",day);
	//var iDateReformatted  = month.concat("-", year);
	var bDate11 = new Date(iDateReformatted1);
//	alert('bDate11 '+ bDate11);
	
	var lbirthDatePlusloantenure = moment(bDate11,"YYYY-MM-DD").add(Number(Lnumber), 'years');
//	alert("after moment lStartDatePlusRecurringYears "+lbirthDatePlusloantenure);
	var lDate = moment(mdate111,"YYYY-MM-DD");
//	alert("after moment lDate "+lDate);
	
	if(lbirthDatePlusloantenure>lDate){
		//alert("false");
		return false;
	}
	else {
